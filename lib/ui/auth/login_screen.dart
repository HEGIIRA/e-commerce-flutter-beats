...
//ini tuh udh tersedia dri library nya
  ...
  final _emailController = TextEditingController(); //controller buat?
          ...
          child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    //ini buat form isi2 an nya
                    controller:
                        _emailController, //controller tuh buat nge controller
                    decoration: const InputDecoration(
                        labelText: "Email", border: OutlineInputBorder()),
                    validator: (value) {
                      //ini sama, bedanya klo isempty itu method dri value
                      if (value == null || value.isEmpty) {
                        //ini klo value nya kosong ATAU emg si user nya ga ngisi gitu
                        return "Email is required"; //bakal muncul ini
                      } //karna ada operator not/bang (!) brarti jdi negatif
                      if (!value.endsWith("@gmail.com")) {
                        //ini klo emailnya ga ada @
                  ...
                  TextFormField(
                    ...
                    obscureText:
                        true, //ini buat ngasih bintang2 pas masukin pw / terenskripsi(bukn data menth melainkan bintang2)
                    decoration: const InputDecoration(
                      labelText: "Password",
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          ...
                          fToast.showToast(
                            //fToast ini subclass dari flutterToast
                            child: Container(
                              padding: const EdgeInsets.symmetric(
                                  horizontal: 45.0,
                                  vertical:
                                      20.0), //inin nihh buat jarak padding nya, klo mau lbih besar tuh
                              decoration: BoxDecoration(
                                //nah ini buat nge dekor si box nya, warna, radius, gitu2
                                color: const Color.fromARGB(
                                    255, 19, 19, 19), //ini warna bg nya
                                borderRadius: BorderRadius.circular(
                                    8.0), //ini si radius/lengkungan kotak
                              ),
                              child: const Text(
                                "Successfully Login!",
